class CustomRadioInput < Formtastic::Inputs::RadioInput

    def input_html_options
        super.merge(:class => "regular-radio")
    end
    ...
    def choice_html(choice)
        builder.radio_button(input_name, choice_value(choice), input_html_options.merge(choice_html_options(choice)).merge(:required => false)) + custom_choice_label(choice) +  template.content_tag(:span,choice.first)
